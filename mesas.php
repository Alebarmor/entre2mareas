...
<main>
	<table style="width:100%">
  		<td>
   			<form method="post" action="controladorCambioMesa.php">
			<button onClick="window.location.href='mesa1.php'"> Mesa 1</button>
			<button onClick="<?php echo $numMesa=3?>window.location.href='mesas.php'">Mesa 2</button>
