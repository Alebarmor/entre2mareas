...
//Se validan los datos anteriores llamando a la función "validacionLogin", definida más abajo, de manera que podermos obtener los errores si los hay
$errores = validacionLogin($conexion, $usuario);

//Se cierra la conexión a la base de datos
cerrarConexionBD($conexion);

//En el caso de que haya errores, se redirige a la página de login y se muestran los errores, en caso contrario se redirige a la página de home con los datos del usuario
if (count($errores) > 0) {
...
//Los distintos errores que nos podemos encontrar se definen aquí: usuario vacío, usuario no registrado, contrasenia vacía, contrasenia incorrecta
...
//Aquí aparece la consulta que se hace con el usuario y contrasenia proporcionados por el formulario
